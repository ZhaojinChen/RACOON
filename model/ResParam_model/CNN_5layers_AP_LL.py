...
class CNN_5layers_AP_LL(nn.Module):
    def __init__(self, input_size, dropout=0.7):
        super(CNN_5layers_AP_LL, self).__init__()
        ...
        self.features = nn.Sequential(
            ...
            nn.BatchNorm3d(8),
            nn.ReLU(),
            PadMaxPool3d(2, 2), # use cropped image finally 
            # ceil mode - exclude an incomplete kernel or stride or not; count_include_pad - for the kernel with padding, take the padding part into consideration or not, here i want to all feature map to be considered.
