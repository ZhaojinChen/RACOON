...
class VGG16(nn.Module):
    def __init__(self, input_size, dropout=0.7):
        ...
        self.features = nn.Sequential(
            nn.Conv3d(in_channels=input_size[0], out_channels=16, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm3d(16),
            nn.ReLU(),
            ...
            PadMaxPool3d(2, 2), # equals to nn.MaxPool3d(2,2,ceil_model=True)
        ...
        self.fnn = nn.Sequential(
            ...
            nn.Linear(512, 256),
            nn.ReLU(),
            nn.Linear(256, 9),   # Output layer for regression
        )
